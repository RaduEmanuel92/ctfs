...
def main():
	md6 	= md6hash()
	leak 	= '22f16715b63da1e585becc0d954e5d281e0952f4b1d2fbc293c6265dd3b56522'
	test 	= '04e88699753cc3641ba8f8ac82e613caa2c62f9d6412a89f471b4519db250d53'
	count 	= 0
	with open('a.txt') as keys:
		for key in keys:
			#print key
			key1 = key
			key2 = key.encode('hex')
			m = md6.hex(key2, 256, key2)
			count +=1
			print m, "  ",str(count), '   116059'
			if m == leak:
